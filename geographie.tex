...
\begin{enumerate}
 \item \textbf{Modul "Geographie in Hochschule und Praxis"}\\ besteht aus:
  \begin{enumerate}
   \item Seminar: Einführung in das Studium der Geographie
   \item Seminar: Das Berufsfeld der Geographie
  \end{enumerate}
  Notenvergabe:
  \begin{enumerate}
   \item Übungsaufgaben, Referate, Hausarbeit
   \item Protokolle
  \end{enumerate}    % [] bewirkt, dass die nummerierung fehlt
\item[] Note = a) 100\% der Note

  \item \textbf{Modul Humangeographie 1} \\ besteht aus:
    \begin{enumerate}
      \item Vorlesung: Einführung in die Humangeographie
      \item Übung Humangeographie A1 (inkl. 1 Tag Exk.)
      \item Übung Humangeographie B1 (inkl. 1 Tag Exk.)
    \end{enumerate}
   Notenvergabe:
    \begin{enumerate}
     \item Klausur \textbf{SEHR LERNINTENSIV!!!}
     \item Präsentationen und/oder Hausarbeit
     \item Präsentationen und/oder Hausarbeit
    \end{enumerate}
\item[] Note = b) 100\% der Note

  \item \textbf{Physische Geographie}  \\ besteht aus:
    \begin{enumerate}
...
\item \textbf{Geographische Erhebungs- und Analysetechniken}  \\ besteht aus:
    \begin{enumerate}
    ...
    Notenvergabe:
    \begin{enumerate}
     \item[] a) Übungsaufgaben
      \item[] b) Klausur
    \end{enumerate}
\item[] Note = a) und b) jeweils 50\% der Note


\item \textbf{Orts-, Regional- und Landesentwicklung/Raumplanung (ORL)}  \\ besteht aus:
    \begin{enumerate}
    ...
    \begin{enumerate}
     \item Klausur
      \item Übungsaufgaben und Referat (inkl. schriftl. Ausarbeitung) oder Planspiel
      \item Protokoll
    \end{enumerate}
    \item[] Note = a) 40\% b) 55\% c) 5\%

\item \textbf{Geoinformatik 1}  \\ besteht aus:
    \begin{enumerate}
     \item Vorlesung: Geoinformatik
      \item Übung: Geoinformatik
      \item Vorlesung: Geostatistik
      \item Übung: Geostatistik
    \end{enumerate}
    Notenvergabe:
    \begin{enumerate}
     \item Klausur
      ...
      \item Übungsaufgaben
    \end{enumerate}
    \item[] Note = jeweils 25\%

\item \textbf{Geoinformatik 2}  \\ besteht aus:
    \begin{enumerate}
      \item Übung: Digitale Kartographie
      \item Übung: GIS-Grundkurs
    \end{enumerate}
    Notenvergabe:
    \begin{enumerate}
     \item Übungsaufgaben
      \item Übungsaufgaben, Klausur
    \end{enumerate}
    \item[] Note = a) 40\% b) 60\%

\item \textbf{Ökologische Planung}  \\ besteht aus:
    \begin{enumerate}
      \item Vorlesung: Grundlagen der ökologischen Planung
      \item Übung: Ökologische Planung
    \end{enumerate}
    Notenvergabe:
    \begin{enumerate}
     \item Klausur
...
\item \textbf{Angewandte Geographie}  \\ besteht aus:
    \begin{enumerate}
      \item Vorlesung: Angewandte Geographie
      \item Seminar: Angewandte Geographie
      \item Seminar: Angewandte Geographie
    \end{enumerate}
    Notenvergabe:
    \begin{enumerate}
     \item[b) \& c)] Präsentation und/oder Hausarbeit
    \end{enumerate}
       \item[] Note = b) oder c) 100\%

\item \textbf{Praktikum}  \\ besteht aus:
    \begin{enumerate}
      \item Praktikumskolloquium (hören und Praktikum vorstellen)
      \item Praktikum
      \item Praktikumsbericht
    \end{enumerate}
    \item[] Note = c) 100\%

    
\item \textbf{Projektbezogenes Geländeseminar}  \\ besteht aus:
    \begin{enumerate}
      \item Seminar: Geländeseminar 1
      \item Seminar: Geländeseminar 2
      \item Projektbericht
    \end{enumerate}
    Notenvergabe:
    \begin{enumerate}
...
\item \textbf{Regionale Geographie}  \\ besteht aus:
    \begin{enumerate}
    ...
    Notenvergabe:
    \begin{enumerate}
     \item Präsentation und/oder Hausarbeit
      \item Präsentation und/oder Hausarbeit
      \item Protokoll
    \end{enumerate}
    \item[] b) 40\% c) 30\% d) 30\% 

\item \textbf{Humangeographie 2}  \\ besteht aus:
    \begin{enumerate}
      \item Vorlesung: Humangeographie 2
      \item Seminar: Humangeographie 2
      \item Tutorium
    \end{enumerate}\newpage
    Notenvergabe:
    \begin{enumerate}
    ...
    \end{enumerate}
    \item[] Note = Prüfung 100\%

\item \textbf{Allgemeine Studien}  \\ besteht aus:
    \begin{enumerate}
...
\item \textbf{Wahlbereich/Nebenfächer}  \\
Notenvergabe:
    \begin{enumerate}
      \item[] Abhängig von der jeweiligen Veranstaltung
 \end{enumerate}
 
\item \textbf{Bachelorarbeit}  \\ besteht aus:
\begin{enumerate}
